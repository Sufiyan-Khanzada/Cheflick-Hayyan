...
<html>  
     ...
     <?php
        include 'header.php';
        include 'dashboard/components/modals/map-modal.php'; 
        ?>
     <body>
        <script>
                    ...
                    <div class="col-md-6 hsf-sec">
                        <div class="home-search-food">
                            ...
                            <div class="hsf-bar">
                                ...
                                <input class="input-field" type="text" placeholder="Enter Location" name="usrnm" > <a href="#mapModal"><i class="fa fa-map icon location"></i></a><br>
