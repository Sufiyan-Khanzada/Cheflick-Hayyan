                    ...
                    <div class="col">
                        ...
                        <div class="col-md-8 bnr-sec">
                            <div class="head-bner-sec">
                                <!--<h5>Get on board</h5>-->
                                <h2>PAYEMENT FORM</h2>
                                <form style="padding:0px; margin:0px; box-shadow: none;">
                                        <div class="form-row">
                                            <div class="form-group-1 col-md-6">
                                               <div class="row ">
                <div class="col-sm-12">
                <div class="myCard">
                <div class="row billing-side">
                        <div class="col-12">
                        <h3 class="card-head">BECOME A CHEF</h3>
                        <div class="row">
                            <div class="col-sm-6">
                               <p class="card-texttt">Name</p>
                               <p class="card-texttt">Contact</p>
                               <p class="card-texttt">Email</p>
                               <p class="card-texttt">Business Name</p>
                               <p class="card-texttt">Address</p>
                               <p class="card-texttt">City</p>
                            </div>
                            <div class="col-sm-6">
                               <p class="card-text-9">Shabab Haider</p>
                               <p class="card-text-9">+920123456789</p>
                               <p class="card-text-9">abc@gmail.com</p>
                               <p class="card-text-9">King Burger</p>
                               <p class="card-text-9">abc street 123</p>
                               <p class="card-text-9">Karachi</p>
                            </div>
                        </div>
                        </div>
                    </div>
                    <div class="row billing-side-1">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6 text-end">
                            ...
                            <p class="bold">Rs.8100</p>
                                           ...
                                           <div class="form-group col-md-6" style="margin-bottom:290px;">
